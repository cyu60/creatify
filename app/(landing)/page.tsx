...
const features = [
  ...
  {
    name: "Simplified Analogies",
    description:
      "Our AI provides simpler analogies to help you grasp difficult concepts, making learning more effective and engaging.",
    icon: Lightbulb, // Replace with an appropriate icon for insights or analogies
  },
  {
  ...
  return (
    <div className="bg-white">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img className="h-8 w-auto" src="/circle_brain_logo.png" alt="" />
            </a>
          </div>
            ...
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <img
                  ...
                  src="https://tailwindui.com/img/logos/mark.svg?bg-goodpinkde=600"
                  alt=""
                />
              </a>
              <button
      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  mindmaps. Dive into complex topics like never before and
                  unleash your creativity.
                </p>

                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <Link href="/sign-in">
                    <Button className="rounded-md bg-goodpink px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-goodpink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-goodpink">
                      Get Started
                    </Button>
                  </Link>
                  <Link href="/sign-in">
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-goodpink">
                Learn Smarter
              </h2>
              ...
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-16">
                  <dt className="text-base font-semibold leading-7 text-gray-900">
                    <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-goodpink">
                      <feature.icon
        ...
        <div className="mx-auto max-w-2xl text-center my-96">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href="/sign-up"
              className="rounded-md bg-goodpink px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-goodpink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-goodpink"
            >
              Sign Up
            </Link>
            <Link
